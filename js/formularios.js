...
window.Formularios = (function () {
    function leerDatos(formulario) {
        ...
        // FormData omite casillas desmarcadas. Para nuestras casillas de opción
        // guardamos un booleano explícito, incluyendo false al desmarcarlas.
        formulario.querySelectorAll('input[type="checkbox"][data-validar]').forEach(function (campo) {
            if (!campo.disabled) {
