...
/*
 * REGIONES Y COMUNAS PARA EL FORMULARIO
 * Fuente: Biblioteca del Congreso Nacional, Mapoteca (consulta: 09/09/2026).
 * https://www.bcn.cl/siit/mapoteca/comunas
 * Datos de reemplazo mientras se obtiene el archivo complementario del docente.
 * Los códigos son texto para conservar sus ceros iniciales.
 */
window.REGIONES = [
    {
        "codigo": "15",
    ...
    {
        "codigo": "11",
        "nombre": "Región Aysén del G. Carlos Ibáñez del Campo",
        "comunas": [
            {
                "codigo": "11201",
                "nombre": "Aysén"
